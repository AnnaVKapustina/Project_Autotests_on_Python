...
class TestUserAddToBasketFromProductPage:
    ...
    def setup(self, browser):
        ...
        self.password = str(time.time()) + "Alsk!#"
...
def test_message_disappeared_after_adding_product_to_basket(browser):
    ...
    page.open()
    page.add_cart()
    page.should_not_be_message_disappeared_after_adding_product()
...
def test_guest_cant_see_product_in_basket_opened_from_product_page(browser):
    ...
    page_cart = BasketPage(browser, browser.current_url)
    page_cart.check_is_cart_empty()
    page_cart.check_is_cart_empty_message()
